              ...
              <div class="card shadow">
                <div class="card-header">
                   <div class="row">
                            ...
                            <div class="col-md-6 ">
                               Управление категориями <br> rasxodov
              ...
              <div class="row">
                   <div class="col-md-12 ">
                    <table  name="slide-fade" is="transition-group">
                                     ...
                                     <tr  v-for="(item, index) in rastoolcat" :key="item.id" >
...
<script>
    ...
    import ModalToolRas from './ModalToolRas'
...
export default {
      ...
      methods: {
             ...
             zakritclick:function (){
                 ...
                 modalcat(){
                         this.$store.commit('INPUTTOOLRAS' , true);
                ...
                udalit: function(event){
                 ...
                 this.$store.commit('DAXCATID', id);
                   ...
                   udalmod(){
                    axios.post('/udaltoolras', {id:this.daxcatid}).then(re => {
                      this.udalitmod=false;
                            this.$store.dispatch('RasToolCat');
      ...
      computed: { 
               ...
               toolrasload(){
                ...
                modaltool(){
                             return this.$store.getters.inputtoolras;
