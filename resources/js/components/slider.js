  ...
  'use strict';
      return function (selector, config) {
        var
          ...
          _transform , // значение транфсофрмации .slider_wrapper
        ...
        var _stepMonth = function() {
              var d = new Date();
              var meses = d.getMonth();
              return -(12 + Number(meses));                
               }
        _transform= _step * (_stepMonth()); 
        _sliderWrapper.style.transform = 'translateX(' + _transform + '%)';   
        var _positionLeftItem = -(_stepMonth()) ;
        var _transformItem = function (direction) {
          if (! _sliderWrapper.classList.contains('perexod')) {
               _sliderWrapper.classList.add('perexod');
            }
